...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1">Author Dashboard</h4>
        <p class="text-muted mb-0">Manage your paper submissions and track review progress</p>
    </div>
    <div class="d-flex gap-2">
        <a href="{{ route('author.papers.create') }}" class="btn btn-primary">
            <i class="fas fa-upload me-1"></i> Submit New Paper
        </a>
    </div>
</div>
